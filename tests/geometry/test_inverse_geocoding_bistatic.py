...
"""Unittest for geometry/inverse_geocoding.py inverse_geocoding_bistatic functionalities"""
...
from arepytools.geometry.inverse_geocoding import (
    ...
    inverse_geocoding_bistatic_init,
)
...
def _doppler_equation_residual(
    ...
    doppler_equation_freq_term = (
        wavelength * freq_doppler * slant_range_rx * slant_range_tx
    )
    residual = (
...
class InverseGeocodingBistaticCoreTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.az_abs_tolerance = 1e-11
        self.rng_abs_tolerance = 1e-15
        ...
        self.azimuth_res = PreciseDateTime.from_utc_string(
            "17-FEB-2020 16:07:09.730322672472"
        )
        self.range_res = 1.9383737324574213e-05

    def test_inverse_geocoding_bistatic_core_case0a(self) -> None:
        """Testing inverse_geocoding_bistatic_core, case 0a"""

        # case0a: 1 ground point (3,), 1 doppler freq, 1 init guess PDT
        az_times, rng_times = inverse_geocoding_bistatic_core(
            trajectory_rx=self.gso_curve,
            trajectory_tx=self.gso_curve,
        ...
        position_rx = self.gso_curve.evaluate(az_times)
        velocity_rx = self.gso_curve.evaluate_first_derivatives(az_times)
        position_tx = self.gso_curve.evaluate(az_times_tx)
        velocity_tx = self.gso_curve.evaluate_first_derivatives(az_times_tx)
    ...
    def test_inverse_geocoding_bistatic_core_case0b(self) -> None:
        """Testing inverse_geocoding_bistatic_core, case 0b"""
    ...
    def test_inverse_geocoding_bistatic_core_case0c(self) -> None:
        """Testing inverse_geocoding_bistatic_core, case 0c"""
    ...
    def test_inverse_geocoding_bistatic_core_case0d(self) -> None:
        """Testing inverse_geocoding_bistatic_core, case 0d"""
    ...
    def test_inverse_geocoding_bistatic_core_case1a(self) -> None:
        """Testing inverse_geocoding_bistatic_core, case 1a"""
    ...
    def test_inverse_geocoding_bistatic_core_case1b(self) -> None:
        """Testing inverse_geocoding_bistatic_core, case 1b"""
    ...
    def test_inverse_geocoding_bistatic_core_case1c(self) -> None:
        """Testing inverse_geocoding_bistatic_core, case 1c"""
    ...
    def test_inverse_geocoding_bistatic_core_case2a(self) -> None:
        """Testing inverse_geocoding_bistatic_core, case 2a"""
    ...
    def test_inverse_geocoding_bistatic_core_case2b(self) -> None:
        """Testing inverse_geocoding_bistatic_core, case 2b"""
    ...
    def test_inverse_geocoding_bistatic_core_case3a(self) -> None:
        """Testing inverse_geocoding_bistatic_core, case 3a"""
    ...
    def test_inverse_geocoding_bistatic_core_case3b(self) -> None:
        """Testing inverse_geocoding_bistatic_core, case 3b"""
    ...
    def test_inverse_geocoding_bistatic_core_case3c(self) -> None:
        """Testing inverse_geocoding_bistatic_core, case 3c"""
    ...
    def test_inverse_geocoding_bistatic_core_case3d(self) -> None:
        """Testing inverse_geocoding_bistatic_core, case 3d"""
    ...
    def test_inverse_geocoding_bistatic_core_case3e(self) -> None:
        """Testing inverse_geocoding_bistatic_core, case 3e"""
    ...
    def test_inverse_geocoding_bistatic_core_case4a(self) -> None:
        """Testing inverse_geocoding_bistatic_core, case 4a"""

        # case4a: N ground point (N,3), 1 doppler freq, M init guesses (M,)
        with self.assertRaises(AmbiguousInputCorrelation):
            _, _ = inverse_geocoding_bistatic_core(
                trajectory_rx=self.gso_curve,
                trajectory_tx=self.gso_curve,
                ground_points=np.full((self.N, 3), self.ground_point),
                frequencies_doppler_centroid=self.doppler_freq,
    ...
    def test_inverse_geocoding_bistatic_core_case4b(self) -> None:
        """Testing inverse_geocoding_bistatic_core, case 4b"""
...
class InverseGeocodingBistaticTest(unittest.TestCase):
    """Testing inverse geocoding bistatic"""
    ...
    def test_inverse_geocoding_bistatic_case4a(self) -> None:
        ...
        # case4a: 1 ground point (3,), 1 doppler freq, no init guess
        az_times, rng_times = inverse_geocoding_bistatic(
            orbit_rx=self.orbit,
            orbit_tx=self.orbit,
            ground_points=self.ground_point,
    ...
    def test_inverse_geocoding_bistatic_case4b(self) -> None:
        ...
        # case4b: 1 ground point (1,3), 1 doppler freq, no init guess
        az_times, rng_times = inverse_geocoding_bistatic(
            orbit_rx=self.orbit,
            orbit_tx=self.orbit,
            ground_points=self.ground_point.reshape(1, 3),
    ...
    def test_inverse_geocoding_bistatic_case4c(self) -> None:
        ...
        # case4c: N ground point (N,3), 1 doppler freq, no init guess
        az_times, rng_times = inverse_geocoding_bistatic(
            orbit_rx=self.orbit,
            orbit_tx=self.orbit,
            ground_points=np.full((self.N, 3), self.ground_point),
    ...
    def test_inverse_geocoding_bistatic_case4d(self) -> None:
        ...
        # case4d: N ground point (N,3), N doppler freqs (N,), no init guess
        az_times, rng_times = inverse_geocoding_bistatic(
            orbit_rx=self.orbit,
            orbit_tx=self.orbit,
            ground_points=np.full((self.N, 3), self.ground_point),
    ...
    def test_inverse_geocoding_bistatic_case4e(self) -> None:
        ...
        # case4e: 1 ground point (3,), M doppler freqs (M,), no init guess
        az_times, rng_times = inverse_geocoding_bistatic(
            orbit_rx=self.orbit,
            orbit_tx=self.orbit,
            ground_points=self.ground_point,
    ...
    def test_inverse_geocoding_bistatic_case4f(self) -> None:
        ...
        # case4f: 1 ground point (1,3), M doppler freqs (M,), no init guess
        az_times, rng_times = inverse_geocoding_bistatic(
            orbit_rx=self.orbit,
            orbit_tx=self.orbit,
            ground_points=self.ground_point.reshape(1, 3),
...
class InverseGeocodingBistaticInitTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.result = PreciseDateTime.from_utc_string(
            "17-FEB-2020 16:07:09.908999712209"
        )

    def test_inverse_geocoding_bistatic_init_case0a(self) -> None:
        """Testing inverse geocoding bistatic init, case 0a"""

        # case 0a: 1 ground point (3,), 1 doppler freq
        az_times = inverse_geocoding_bistatic_init(
            orbit_rx=self.orbit,
            orbit_tx=self.orbit,
            ground_points=self.ground_point,
            frequencies_doppler_centroid=self.doppler_freq,
    ...
    def test_inverse_geocoding_bistatic_init_case0b(self) -> None:
        """Testing inverse geocoding bistatic init, case 0a"""
    ...
    def test_inverse_geocoding_bistatic_init_case0c(self) -> None:
    ...
    def test_inverse_geocoding_bistatic_init_case1a(self) -> None:
    ...
    def test_inverse_geocoding_bistatic_init_case1b(self) -> None:
    ...
    def test_inverse_geocoding_bistatic_init_case2a(self) -> None:
    ...
    def test_inverse_geocoding_bistatic_init_case2b(self) -> None:
    ...
    def test_inverse_geocoding_bistatic_init_case3(self) -> None:
